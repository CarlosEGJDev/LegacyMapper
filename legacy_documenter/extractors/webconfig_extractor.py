...
class WebConfigExtractor:
    """Provides the cohesive WebConfigExtractor responsibility for this module."""
    ...
    def sanitize_connection_string(self, value: str) -> str:
        """Performs sanitize connection string while preserving this module's deterministic contract."""
